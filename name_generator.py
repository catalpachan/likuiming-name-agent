...
class NameGenerator:
    ...
    CHAR_STROKES = {
        ...
        '木': ['東', '林', '森', '杰', '楠', '梓', '榆', '桐', '樺', '棟', '梁', '梅', '松', '柏', '桂', '榮', '華', '英', '芳', '萍', '芝', '芬', '芸', '菁', '萌', '萱', '蘭', '芬', '儀', '蓓', '藍', '蕾', '蔓', '藝', '藍'],
    ...
    AUSPICIOUS_CHARS = {
        ...
        '木': ['東', '林', '森', '杰', '楠', '梓', '榆', '桐', '樺', '棟', '梁', '梅', '松', '柏', '桂', '榮', '華', '英', '芳', '萍', '芝', '芬', '芸', '藍', '蘭', '蕾', '蔓', '藝', '芬', '藍', '儀', '蕾', '藍'],
        '火': ['炎', '煜', '爍', '煥', '炳', '燦', '靈', '明', '輝', '耀', '光', '照', '晴', '晶', '智', '暉', '曦', '倫', '烈', '炬', '煜', '燁', '爍', '炯', '烈', '耀', '曦', '炬'],
        '土': ['坤', '城', '培', '基', '堂', '堃', '均', '聖', '堅', '山', '岩', '峰', '岳', '峻', '崇', '嶺', '嵐', '岱', '巍', '壇', '壑', '壓', '墟', '壕', '壇', '壑', '壓'],
        '金': ['鋒', '銘', '銳', '鈞', '錦', '鈺', '鑫', '銀', '銅', '鐵', '鋼', '鎖', '鍵', '錢', '鍋', '鏡', '鐘', '鐵', '鋭', '鋒', '銘', '鋭', '鈞', '錦', '鐘', '鋭']
    }
    ...
    def get_name_meaning(self, char):
        ...
        meanings = {
            ...
            '東': '東方、朝氣', '林': '森林、茂盛', '森': '森林、繁榮', '杰': '傑出、卓越',
